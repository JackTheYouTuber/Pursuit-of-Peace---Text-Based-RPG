...
class ProfileSelector:
    """Handles profile selection, creation, and loading dialogs."""

    @staticmethod
    def select_or_create(root: tk.Tk, profile_mgr: ProfileManager, data_loader, logger=None):
        """
        Show modal dialog to select or create a profile.
        Returns (profile_name, player_state) or (None, None) if cancelled.
        """
