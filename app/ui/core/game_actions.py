...
Message policy (Step 5.2):
  • Informational results → window.post_message()  (inline strip, no popup)
  • Errors / warnings    → messagebox.showerror / showwarning  (kept as popup)
  • Game-over            → messagebox.showwarning  (modal, then reset)
"""
...
class GameActions:
    ...
    def _handle_game_over(self, msg: str):
        # Keep game-over as a modal warning — it requires the player's attention
